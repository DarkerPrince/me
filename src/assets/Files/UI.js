export const uiFiles = [
  {
    ...
    hashimg: "LOP@CV9G%2%M~BX9t6M{0fs+ofbJ",
    primarycolor: "#00DBDE",
    subtitle:
      "Influence. Inspire. Impact. Be the catalyst for change in the digital world.",
    problem:
      "Limited Reach: One of the challenges faced by influencers is reaching a wider audience and expanding their reach. Despite their talent and creativity, many influencers struggle to connect with brands and communities that align with their values and niche. Our influencer platform resolves this problem by providing a centralized hub where influencers can showcase their talents, collaborate with brands, and reach a targeted audience that is genuinely interested in their content. With our platform, influencers can unlock new opportunities and amplify their impact in the digital space.",
    solution:
    ...
    userPersona: [
      {
        ...
        favBrand: [""],
        socialMedia: [
          { name: "Youtube", color: "#212121", value: 50 },
          { name: "Facebook", color: "#212121", value: 15 },
          { name: "Instagram", color: "#212121", value: 10 },
          { name: "Tiktok", color: "#212121", value: 35 },
        ],
        tech: [
          { name: "Mobile", color: "#E38627", value: 90 },
          { name: "Laptop", color: "#E38627", value: 10 },
        ],
        goal: [
          "Sarah wants to collaborate with established fashion brands and expand her audience beyond her current followers.",
          "She aims to increase her brand partnerships and create content that resonates with her target audience.",
        ],
        frustration: [
          "Sarah finds it challenging to find brands that align with her values and niche.",
          "She struggles to connect with relevant communities and often receives collaboration offers that are not a good fit for her content.",
        ],
      },
      {
        img: "image lists",
        ...
        socialMedia: [
          ...
          { name: "Facebook", color: "#E38627", value: 50 },
          { name: "Instagram", color: "#E38627", value: 10 },
          { name: "Tiktok", color: "#E38627", value: 35 },
        ],
        tech: [
          { name: "Mobile", color: "#E38627", value: 70 },
          { name: "Laptop", color: "#E38627", value: 10 },
          { name: "Tablet", color: "#E38627", value: 30 },
        ],
        goal: [
      ...
      },
      {
        ...
        favBrand: [""],
        socialMedia: [
          { name: "Youtube", color: "#E38627", value: 10 },
          { name: "Facebook", color: "#E38627", value: 15 },
          { name: "Instagram", color: "#E38627", value: 10 },
          { name: "Tiktok", color: "#E38627", value: 80 },
        ],
        tech: [
          { name: "Mobile", color: "#E38627", value: 90 },
          { name: "Laptop", color: "#E38627", value: 10 },
        ...
        goal: [
          ...
          "He wants to share his expertise with a targeted audience and inspire others to lead a healthy lifestyle.",
        ],
        frustration: [
          "James struggles with finding meaningful collaborations with fitness brands that align with his values.",
          " He also faces difficulty in expanding his reach beyond his current follower base and connecting with like-minded fitness enthusiasts.",
        ],
      },
      {
        img: "image lists",
        ...
        tech: [
          { name: "Mobile", color: "#E38627", value: 90 },
          { name: "DSLR Camera", color: "#E38627", value: 10 },
          { name: "Laptop", color: "#E38627", value: 10 },
        ],
        goal: [
        ...
        frustration: [
          "Emma struggles to find travel brands that align with her sustainable and eco-friendly values. She also faces challenges in discovering niche travel communities and reaching a broader audience interested in authentic travel experiences.",
        ],
      },
    ],
    sketch: [],
    wireframe: [
      "https://dl.dropboxusercontent.com/scl/fi/nj2cwbz1zzsjjwto45ghf/Wireframe-Design.png?rlkey=odi85s7ji6kmu058ylwqjsgpa&dl=0",
    ],
    mockup: [
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/48r0ose8f2coy1uchdxs5/final-gif-mock.gif?rlkey=08xe69q755n1h6pml34bmlqr6&dl=0",
        title: "Landing Page",
        subtitle:
          "The layout is intuitive, guiding visitors through important sections such as the hero section, influencer showcase, brand collaborations, platform features, pricing, testimonials, and contact/support. The color scheme and typography are carefully chosen to reflect the brand's identity. Overall, the design creates a seamless and engaging experience, encouraging influencers to join and maximize their impact.",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/nistf5djh77d71hi4grt9/Mockup-2.png?rlkey=33dgx2hmq6ynpnyz9cqaei67p&dl=0",
        title: "Influencers and Marketers",
        subtitle:
          "Sukify offers a powerful platform for influencers and marketers alike. Influencers can connect with their target audience, find brand collaborations aligned with their values, and access helpful tools for content creation and analytics. Marketers benefit from a diverse pool of influential personalities, enabling them to amplify their brand reach and find the perfect fit for their campaigns. Sukify serves as a valuable hub, connecting influencers and marketers for successful collaborations and mutual success.",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/7w0n4v6dmeyfwwh7wh97e/Mockup-3.png?rlkey=xtwjcpf86v1kvr1x73w0ord1i&dl=0",
        title: "Marketer Dashboard",
        subtitle:
          "Sukify's marketer dashboard is user-friendly and efficient. It allows marketers to manage campaigns, discover influencers, and access performance analytics easily. With intuitive navigation and collaboration tools, marketers can streamline their influencer marketing efforts for optimal results.",
      },

      {
        img: "https://dl.dropboxusercontent.com/scl/fi/t8l09v7yayrgbx4mmbk0c/Mockup-1.png?rlkey=1z8l8w4hx69fxkjo23kwo9yp0&dl=0",
        title: "Influencer Dashboard",
        subtitle:
          "Sukify's influencer job dashboard streamlines the process for influencers, simplifying job discovery, application tracking, communication with brands, task management, performance analytics, and payment/invoicing. It provides a user-friendly platform that empowers influencers to succeed in their careers.",
      },
    ],

    sampleView: [
      "https://dl.dropboxusercontent.com/scl/fi/o9p7jc267agq2vhzsyvpu/Campaign-Members.png?rlkey=yakffdxw5skmd3uu2lti786jy&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/98idw402j75wi257kgc1z/marketer-chat-platform.png?rlkey=6x2o1b68pyxucbezhauazgaw6&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/sqd2cy9g1ta631c77mb29/more-detials.png?rlkey=dr5cv50jshydhqos98e2umrre&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/u6da7kq5b40y4mopuc3c6/Second.png?rlkey=vslt2ol715m4b0j4fv5suqsem&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/kd1ztkwm5ua7uzss2pyyl/Influencer-category.png?rlkey=w9sq2ur17y7v7gorniw7pc8ir&dl=0",
    ],
  ...
  },
  {
    ...
    hashimg: "-",
    primarycolor: "#3170b5",
    subtitle: "One Network Bringing It All Together.",
    problem:
      "In Ethiopia, the absence of a dedicated platform for education and job opportunities hinders individuals from accessing quality education and finding suitable employment. This creates barriers to their educational and professional development, impacting their future prospects.",
    solution:
      "ELMIS platform solves the education and job challenges in Ethiopia. It offers an e-learning platform for learning, a job portal for employment, and various microservices for comprehensive support. Unlock your potential with ELMIS for a brighter future.",
    font: "Poppins",
    colors: ["#32A583", "#212121", "#195241", "#18385A"],
    userPersona: [
      {
        img: "image lists",
        name: "Eyerusalem Getahun",
        married: false,
        age: 23,
        location: "Addis Ababa",
        position: "",
        ...
        goal: [
          ...
          "Apply for a job and book an appointment for an interview and easily can apply multiple times.",
        ],
        frustration: [
          "Posts not reachable to other who have the same type of interest",
          "Unable to receive as much as knowledge as she expected",
        ],
      },
      {
        img: "image lists",
      ...
      },
      {
        ...
        goal: [
          "Find a short-term job internationally.",
          "Apply for a job and book an appointment for an interview and easily can apply multiple times.",
          " He also prefers to take other social courses from the top college here in Ethiopia to advance his career.",
        ],
        frustration: [
          "Posts not reachable to other who have the same type of interest",
          "Unable to receive as much as knowledge as she expected",
    ...
    mockup: [
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/vuj5bq9vk48tk5dsiyxkw/Mock-1.png?rlkey=y8r6o53tcjk36kjxhi2pmltlq&dl=0",
        title: "Organization Dashboard",
        subtitle:
          "The organization dashboard UI is user-friendly and intuitive. It offers a clear overview of metrics and data, presenting them in visually appealing charts and graphs. The navigation is logical and customizable, allowing organizations to personalize their view. Task management, collaboration, and communication features streamline workflow, while reporting and analytics provide valuable insights.",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/aa8uyy10nyltm27vnf2xw/Mock-3.png?rlkey=k5gywhqf5q62d3yvwkpmr0rrt&dl=0",
        title: "Personal Dashboard",
        subtitle:
          "The personal dashboard for laborers has a user-friendly UI design that allows them to showcase their education, work experience, and other personal details effectively. It provides interactive features for easy profile management and highlights key qualifications for potential employers.",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/erlvlkd395357l3pkafsy/Mock-2.png?rlkey=chw51ijx36m0u31nhayx9m51f&dl=0",
        title: "Data Statistics Preview",
        subtitle:
          "The data preview statistics dashboard has a concise and visually appealing UI design. It presents key data insights and statistics in an easily understandable format, leveraging charts, graphs, and visual elements. The dashboard allows users to quickly preview and analyze data trends, patterns, and summary statistics, facilitating informed decision-making.",
      },
    ],
    sampleView: [
      "https://dl.dropboxusercontent.com/scl/fi/3g4n9ufcq5qfeq1kg6lhz/Dahboard-Landing-Page.png?rlkey=ptxnn9jbkh1mjejbg7u59vdkx&dl=0",
      ...
      "https://dl.dropboxusercontent.com/scl/fi/vxz4nzkozrdgbijyzlywe/profile-Dark-mode.png?rlkey=dwjy0c1rgq6y0khenngh5umqg&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/qvxoml1v51tiojilmj645/Master-dashboard.png?rlkey=n9h592f50gnxnj8qnr0qs8lph&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/lehtb38mql081q4cvl6q9/Demand-Management-job-order-final.png?rlkey=ts5zlaqo568x152hu6qupv84y&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/b9bzgdxjqmi3m6tsh04e8/Immigrant-report.png?rlkey=wys2j0v3iulqn79y7qdhdqgy3&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/d15aqzillabq441aaswk9/Services-page.png?rlkey=n1rjlxj2sm1pv29eyp1tkno8g&dl=0",
      "https://dl.dropboxusercontent.com/scl/fi/c95abiwfdbiah226ut5g8/sample1.png?rlkey=fe7j13gla7wg419jgpofcjy5q&dl=0",
    ],
    tag: ["UI/UX", "Figma", "Photoshop", "Illustrator"],
  },
  {
  ...
  },
  {
    ...
    hashimg: "-",
    primarycolor: "#CC9901",
    subtitle: "Where Knowledge Meets Excitement!",
    problem:
      "Many people face a lack of interactive and engaging platforms to challenge their knowledge and have fun with friends. Traditional trivia games or quiz apps often fail to provide the excitement and competitive element that users seek. As a result, people are left longing for a more dynamic and entertaining way to test their skills and engage in friendly competition.",
    solution:
    ...
    userPersona: [
      {
        ...
        frustration: [
          "Kevin often finds traditional trivia games or quiz apps to be repetitive and lacking in the competitive aspect he seeks. He feels that these platforms fail to provide the excitement and engagement he desires, leading to a sense of boredom and disinterest.",
        ],
      },
      {
        img: "image lists",
        ...
        frustration: [
          "Sarah often finds traditional trivia games or quiz apps to be lacking in educational content. She feels that these platforms focus more on entertainment rather than providing valuable insights and learning opportunities. This leaves her longing for a platform that strikes a balance between fun and educational value.",
        ],
      },
      {
        img: "image lists",
        ...
        quote: "",
        about:
          "Alex is a 25-year-old software developer from Toronto, Canada. He enjoys challenging his knowledge and engaging in friendly competitions with his colleagues and friends. Alex is highly tech-savvy and appreciates platforms that offer a seamless user experience and innovative features.",
        favBrand: [""],
        socialMedia: [
          { Reddit: "50" },
          { Discord: "15" },
        ...
        frustration: [
          "Alex often finds traditional trivia games or quiz apps to be lacking in innovation and modernity. He feels that these platforms fail to utilize emerging technologies to enhance the user experience, resulting in a sense of monotony and predictability.",
        ],
      },
    ],
    sketch: [],
    wireframe: [
      "https://dl.dropboxusercontent.com/scl/fi/voh8ioc2awlxc32zmc34t/Group-47887.png?rlkey=tj9zdnsq4xrrr1rnhixm32bg5&dl=0",
    ],
    mockup: [
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/6ugrtdt7j9ii26nxiprbf/Mockup-1.png?rlkey=d5xjiaw2bgkwvq9o6wftvf5b8&dl=0",
        title: "",
        subtitle: "",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/ox8i5kpeolplfeqjw9p8y/Mockup-3.png?rlkey=145f8wpv80sc0px5yi4j8785u&dl=0",
        title: "",
        subtitle: "",
      },
      {
        img: "https://dl.dropboxusercontent.com/scl/fi/shgcf6pn0dh8fw8g7m0iy/Mockup-2.png?rlkey=zoxkfemt5tf5k6x9mjnasfalh&dl=0",
        title: "",
        subtitle: "",
      },
    ],
