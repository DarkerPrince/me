  ...
  return (
    <div className="gap-12">
      ...
      <div className="flex flex-wrap gap-4 my-6">
        <div className="bg-white dark:bg-white/10 shadow-md p-4 flex flex-col rounded-md items-center gap-2">
      ...
      <div className="rounded-lg bg-slate-100 dark:bg-slate-100/10 shadow-inner flex w-full overflow-x-scroll overflow-visible ">
