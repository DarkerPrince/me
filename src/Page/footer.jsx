function Footer() {
  return (
    ...
    <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-400 sm:mt-0">
        ...
        <li>
            <a href="#category" className="mr-4 hover:underline md:mr-6">Skills</a>
        </li>
        <li>
         <a href="#skill" className="mr-4 hover:underline md:mr-6">Projects</a>
        </li>
        <li>
        <a href="#profession" className="hover:underline">Experience</a>
        </li>
    </ul>
</footer>
  )
