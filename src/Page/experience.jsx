...
function Experience() {
  ...
  return (
    <div className="mt-12 lg:w-1/2 py-3 flex flex-col w-full  justify-center rounded-3xl mx-auto p-4 lg:p-12 bg-gradient-to-br from-Primary to-Secondary items-center sm:py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center">
            <div className="flex justify-start w-full mx-auto items-center">
              ...
              <p className=" font-normal text-white">
                On a mobile platform for e-commerce, I've been working as a UI/UX designer and Flutter developer.
              </p>
              ...
              <button
                className="inline-flex relative flex-col gap-2 group
                      "
              >
                <p className=" hover:underline hover:text-white font-normal mb-3 text-slate-600/70 text-xs rounded-md">
                  More
                </p>
                  ...
                  <ul className="flex flex-col font-normal px-2 mb-3 list-disc text-left space-y-4">
                    ...
                    <li>
                      <p>
                        ...
                        graphics designer also I have done graphic designs for social media
          ...
          <div className="flex flex-col sm:flex-row items-center">
            <div className="flex justify-end w-full mx-auto items-center">
              ...
              <p className=" font-normal">
                I was employed as a software engineer and UI designer
