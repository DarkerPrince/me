    ...
    <div className="h-[400px] relative bg-white p-4 hover:shadow-xl rounded-2xl flex flex-col justify-between group">
        <div className=' absolute p-4 -top-2 -right-2 bg-slate-200 flex items-center justify-center rounded-md '>
          ...
          <div className="flex flex-col items-start gap-2 mt-4">
            ...
            <div className="h-48 w-full bg-Primary  overflow-hidden group-hover:overflow-visible rounded-xl" >
        <div className="flex w-full h-full items-end justify-center">
          <img src={graphicImg1} alt="" className="w-1/4  -mr-4 mt-8 rounded-md translate-y-8 group-hover:-translate-y-6 duration-300 ease-in-out " />
          <img src={graphicImg2} alt="" className="w-1/3 z-10  rounded-md translate-y-8 group-hover:-translate-y-2  duration-300 ease-in-out" />
          <img src={graphicImg3} alt="" className="w-1/4 -ml-4 mt-8 rounded-md translate-y-8 group-hover:-translate-y-6 duration-300 ease-in-out" />
        </div>
        </div>
        </div>
  )
