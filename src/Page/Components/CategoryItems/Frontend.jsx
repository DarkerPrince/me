...
function Frontend() {
  return (
    <div className="h-[400px] relative bg-white hover:shadow-xl p-4 group  rounded-2xl flex flex-col justify-between ">
    ...
    <div className="h-48 w-full bg-Primary overflow-hidden group-hover:overflow-visible rounded-xl flex justify-center self-center items-end ">
        ...
        <img src={land} alt="" className=" w-2/3 group-hover:-translate-y-16 duration-300 ease-in-out" />
          <img
            src={getin}
            alt=""
            className="w-1/2 -ml-12 rounded-xl mt-12 bg-green-300 shadow-lg group-hover:-translate-y-4 duration-300 ease-in-out"
          />
        </div>
      </div>
   </div>
