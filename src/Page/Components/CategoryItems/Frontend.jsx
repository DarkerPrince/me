...
function Frontend() {
  return (
    <div className="h-[400px] relative bg-white  dark:bg-white/10 text-slate-700 dark:text-slate-200 hover:dark:bg-white/20 hover:shadow-xl p-4 group  rounded-2xl flex flex-col justify-between ">
